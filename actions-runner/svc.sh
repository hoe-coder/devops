...
SVC_NAME="actions.runner.hoe-coder-devops.wifi-eduroam-studtech-32-9b-2c-b5-e5-1b"
SVC_NAME=${SVC_NAME// /_}
SVC_DESCRIPTION="GitHub Actions Runner (hoe-coder-devops.wifi-eduroam-studtech-32-9b-2c-b5-e5-1b)"
